...
/******/ 	return __webpack_require__(__webpack_require__.s = "./client/SSO/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./client/SSO/index.css":
/*!******************************!*\
  !*** ./client/SSO/index.css ***!
  \******************************/
...
var _url = __webpack_require__(/*! ../lib/url */ "./client/lib/url.js");

var _sso = __webpack_require__(/*! ./sso */ "./client/SSO/sso.js");

var _sso2 = _interopRequireDefault(_sso);

__webpack_require__(/*! ./index.css */ "./client/SSO/index.css");

__webpack_require__(/*! ./reset.css */ "./client/SSO/reset.css");
...
var searchObj = (0, _url.getUrlParams)(location.href);
...
// 来自哪个网站
var redirectUrl = searchObj.from || '';

// origin白名单
var whitelist = [_config2.default.INDEX_DOMAIN, _config2.default.CMS_DOMAIN];
...
(function () {
  ...
  reactHotLoader.register(searchObj, 'searchObj', '/Users/garven/codetest/realProject/myblog/client/SSO/index.js');
  reactHotLoader.register(redirectUrl, 'redirectUrl', '/Users/garven/codetest/realProject/myblog/client/SSO/index.js');
  reactHotLoader.register(whitelist, 'whitelist', '/Users/garven/codetest/realProject/myblog/client/SSO/index.js');
  leaveModule(module);
})();
...
var _$ = __webpack_require__(/*! ../lib/$ */ "./client/lib/$.js");

var _$2 = _interopRequireDefault(_$);

var _ajax = __webpack_require__(/*! ../lib/ajax */ "./client/lib/ajax.js");
...
var $loginForm = (0, _$2.default)('.login-form');
var $tips = (0, _$2.default)('.tips');
var $captcha = (0, _$2.default)('.img--captcha');
var $account = (0, _$2.default)('.inp-account');
var $password = (0, _$2.default)('.inp-password');
var $captchaText = (0, _$2.default)('.inp-captcah');
var $btnSubmit = (0, _$2.default)('.btn-submit');
var $linkGithubLogin = (0, _$2.default)('.link--github');
var $iframe = (0, _$2.default)('.iframe');
...
var _default = function _default() {
  ...
  // 设置游客登录跳转的url
  $linkGithubLogin.href = 'https://github.com/login/oauth/authorize/?client_id=f3af6057b71e9fbd6951&redirect_uri=' + _config2.default.SSO_DOMAIN + '/github/authorization?from=' + location.href;

  // 更新验证码
  var updateCaptcha = function updateCaptcha() {
    return $captcha.src = '/api/captcha?id=' + new Date().getTime();
  };
  updateCaptcha();
  $captcha.addEventListener('click', updateCaptcha, false);

  // 更新提示
  var updateTips = function updateTips(text) {
    return $tips.textContent = text;
  };

  // 若是在cookie中有了access_token, 则直接跨域传递它
  var access_token = searchObj.access_token;
  if (access_token) {

    // 发送access_token
    $iframe.contentWindow.postMessage({ access_token: access_token }, $iframe.src);
  ...
  var submitHandle = function submitHandle() {
    ...
    var data = {
      ...
      password: _config2.default.cryptoPwd(_jsMd2.default, $account.value, $password.value),
...
(function () {
  ...
  reactHotLoader.register($loginForm, '$loginForm', '/Users/garven/codetest/realProject/myblog/client/SSO/sso.js');
  reactHotLoader.register($tips, '$tips', '/Users/garven/codetest/realProject/myblog/client/SSO/sso.js');
  reactHotLoader.register($captcha, '$captcha', '/Users/garven/codetest/realProject/myblog/client/SSO/sso.js');
  reactHotLoader.register($account, '$account', '/Users/garven/codetest/realProject/myblog/client/SSO/sso.js');
  reactHotLoader.register($password, '$password', '/Users/garven/codetest/realProject/myblog/client/SSO/sso.js');
  reactHotLoader.register($captchaText, '$captchaText', '/Users/garven/codetest/realProject/myblog/client/SSO/sso.js');
  reactHotLoader.register($btnSubmit, '$btnSubmit', '/Users/garven/codetest/realProject/myblog/client/SSO/sso.js');
  reactHotLoader.register($linkGithubLogin, '$linkGithubLogin', '/Users/garven/codetest/realProject/myblog/client/SSO/sso.js');
  reactHotLoader.register($iframe, '$iframe', '/Users/garven/codetest/realProject/myblog/client/SSO/sso.js');
  reactHotLoader.register(_default, 'default', '/Users/garven/codetest/realProject/myblog/client/SSO/sso.js');
  leaveModule(module);
})();
...
var _default = function _default(selector, target) {
...
(function () {
  ...
  reactHotLoader.register(getById, "getById", "/Users/garven/codetest/realProject/myblog/client/lib/$.js");
  reactHotLoader.register($s, "$s", "/Users/garven/codetest/realProject/myblog/client/lib/$.js");
  reactHotLoader.register(getByClassName, "getByClassName", "/Users/garven/codetest/realProject/myblog/client/lib/$.js");
  reactHotLoader.register(getByTagName, "getByTagName", "/Users/garven/codetest/realProject/myblog/client/lib/$.js");
  reactHotLoader.register(_default, "default", "/Users/garven/codetest/realProject/myblog/client/lib/$.js");
  leaveModule(module);
})();
...
(function () {
  ...
  reactHotLoader.register(_default, 'default', '/Users/garven/codetest/realProject/myblog/client/lib/ajax.js');
  leaveModule(module);
})();
...
(function () {
  ...
  reactHotLoader.register(getUrlParams, 'getUrlParams', '/Users/garven/codetest/realProject/myblog/client/lib/url.js');
  reactHotLoader.register(getUrlOrigin, 'getUrlOrigin', '/Users/garven/codetest/realProject/myblog/client/lib/url.js');
  leaveModule(module);
})();
...
/******/ });
//# sourceMappingURL=sso-97f957fa787167d3a4e9.js.map