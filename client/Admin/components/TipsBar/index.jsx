  ...
  locationHandle () {
    ...
    window.jp_location = {
      ...
      getIp: res => {
        ...
        jsonp.get(`http://api.k780.com/?app=weather.today&weaid=${result.ip}&appkey=${appkey}&sign=${sign}&format=json&jsoncallback=jp_location.getWeather`, 'weather')
          .then(res => {
    ...
    jsonp.get(`http://api.k780.com/?app=ip.local&appkey=${appkey}&sign=${sign}&format=json&jsoncallback=jp_location.getIp`, 'ip')
    jsonp.delete('ip')
