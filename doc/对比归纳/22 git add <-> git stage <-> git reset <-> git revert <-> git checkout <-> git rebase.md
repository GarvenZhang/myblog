...
<img src='git命令对比归纳-5.png' alt='git命令对比归纳-5.png' width='50%'/>
...
<img src='git命令对比归纳-10.png' alt='git命令对比归纳-10.png' width='50%'/>

### 3.2 git checkout file

和带文件路径 git reset 非常像，除了它更改的是工作目录而不是缓存区

<img src='git命令对比归纳-11.png' alt='git命令对比归纳-11.png' width='50%'/>
...
<img src='git命令对比归纳-12.png' alt='git命令对比归纳-12.png' width='50%'/>
...
<img src='git命令对比归纳-13.png' alt='git命令对比归纳-13.png' width='50%'/>
...
<img src='git命令对比归纳-14.png' alt='git命令对比归纳-14.png' width='50%'/>
...
<img src='git命令对比归纳-15.png' alt='git命令对比归纳-15.png' width='50%'/>
