...
CREATE TABLE IF NOT EXISTS `myblog`.`Category` (
  ...
  `total` INT NOT NULL DEFAULT 0 COMMENT '该类别的文章总数',
  PRIMARY KEY (`id`))
ENGINE = InnoDB
COMMENT = '文章类别表';
...
CREATE TABLE IF NOT EXISTS `myblog`.`User` (
  ...
  `role` INT NOT NULL DEFAULT 0 COMMENT '0 - 普通用户\n1 - 博主',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `myblog`.`Like` (
  ...
  `type` INT NOT NULL COMMENT '0 - 博文点赞\n1 - 评论点赞\n2 - 回复点赞\n3 - 作品点赞',
  `status` INT NOT NULL COMMENT '0 - 取点赞\n1 - 有点赞',
